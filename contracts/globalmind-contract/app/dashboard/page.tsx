...
export default function DashboardPage() {
  ...
  const STATS = [
    { label: "Score PoEC",       value: score.toString(),      suffix: "pts", color: "text-[#00f5c4]" },
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      {!isConnected ? (
        ...
        <>
          {/* Profile card */}
          <div className="p-6 rounded-2xl bg-gradient-to-br from-[#00f5c4]/5 to-transparent border border-[#00f5c4]/10 mb-6">
            ...
            <div className="mb-2 flex justify-between text-xs text-gray-500">
              ...
              <span className="text-[#00f5c4] font-mono">{score.toString()} / 500 pts</span>
            </div>
            <div className="h-2 rounded-full bg-white/5">
              <div
                className="h-2 rounded-full bg-gradient-to-r from-[#00f5c4] to-blue-400 transition-all duration-700"
          ...
          <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5">
            ...
            <div className="space-y-2 text-xs text-gray-500">
              <div className="flex justify-between">
                ...
                <span className="text-[#00f5c4]">Acurácia</span>
              </div>
              <div className="flex justify-between">
